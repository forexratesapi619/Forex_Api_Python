# forex_rate.py/main.py
# Import ForexRate API Class
from forex_rate import ForexRate

def main():

    # An API key, you can get free at https://forexratesapi.com/register/
    forex_api = ForexRate(api_key='API_KEY') 
   # Example: Get symbols list, Documentation : https://forexratesapi.com/documentation/
...
"""
    ...
    print("Symbols List:", symbols_list)                                  done

    # Example: Get profile of a currency                                  done
    symbol_profile = forex_api.get_profile('1')x
    print("Currency Profile of your desired country :", symbol_profile)

    symbol_profile = forex_api.get_profile('EUR')                         done
    print("Currency Profile BY IDS:", symbol_profile)

    # Example: Convert currency                                           done
